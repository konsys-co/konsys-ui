...
var IconStyled = exports.IconStyled = _styledComponents2.default.i(_templateObject, function (props) {
  ...
  return (0, _styledComponents.css)(_templateObject2, props.margin && (0, _styledComponents.css)(_templateObject3, props.margin), props.spin && (0, _styledComponents.css)(_templateObject4, props.theme.animate ? (0, _styledComponents.css)(_templateObject5, props.theme.animate.spin, props.theme.animate.time.loading) : (0, _styledComponents.css)(_templateObject5, _variables.animate.spin, _variables.animate.time.loading)), props.fontSize && (0, _styledComponents.css)(_templateObject6, props.fontSize));
});
