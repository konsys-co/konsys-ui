...
var _templateObject = _taggedTemplateLiteral(['\n\tdisplay: inline-block;\n\tposition: relative;\n\twidth: 100%;\n'], ['\n\tdisplay: inline-block;\n\tposition: relative;\n\twidth: 100%;\n']),
    ...
    _templateObject11 = _taggedTemplateLiteral(['right: 16px'], ['right: 16px']),
    _templateObject12 = _taggedTemplateLiteral(['left: 16px'], ['left: 16px']),
...
var InputElement = exports.InputElement = _styledComponents2.default.input(_templateObject2, _variables.fonts.style.extraLight, function (props) {
	...
	return (0, _styledComponents.css)(_templateObject3, props.prefix && (0, _styledComponents.css)(_templateObject4), props.suffix && (0, _styledComponents.css)(_templateObject5), props.width && (0, _styledComponents.css)(_templateObject6, props.width, props.width), props.ghost && (0, _styledComponents.css)(_templateObject7), props.large && (0, _styledComponents.css)(_templateObject8, props.theme.fonts ? props.theme.fonts.size.subTitle : _variables.fonts.size.subTitle, props.prefix && (0, _styledComponents.css)(_templateObject9), props.suffix && (0, _styledComponents.css)(_templateObject10), _styled2.default, function (props) {
		return props.theme.fonts ? props.theme.fonts.size.normal : _variables.fonts.size.normal;
	}, function (props) {
		return props.suffix ? (0, _styledComponents.css)(_templateObject11) : (0, _styledComponents.css)(_templateObject12);
	}), props.small && (0, _styledComponents.css)(_templateObject13, props.theme.fonts ? props.theme.fonts.size.label : _variables.fonts.size.label, props.prefix && (0, _styledComponents.css)(_templateObject14), props.suffix && (0, _styledComponents.css)(_templateObject15), _styled2.default, function (props) {
